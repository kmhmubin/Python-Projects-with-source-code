...
for n in range(100):
    ...
    try:
        ...
        try:
            superlike = driver.find_element_by_xpath('//*[@id="modal-manager"]/div/div/button[2]')
            superlike.click()
            sleep(2)
        except Exception:
            try:
                home_screen = driver.find_element_by_xpath('//*[@id="modal-manager"]/div/div/div[2]/button[2]')
                home_screen.click()
                sleep(2)
            except Exception:
